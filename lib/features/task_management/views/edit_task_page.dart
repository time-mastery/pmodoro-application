...
class EditTaskPage extends ConsumerStatefulWidget {
  const EditTaskPage({super.key, this.editItem});
...
class _AddTaskPageState extends ConsumerState<EditTaskPage> {
  ...
  void initState() {
    ...
    if (widget.editItem != null) {
      ...
      descriptionController.text = widget.editItem!.description;
      dateTime = widget.editItem!.deadLineTime;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final asyncAddTask = ref.watch(editTaskProvider);
                  ...
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      if (dateTime == null) {
                        ...
                        ref.read(editTaskProvider.notifier).editTask(
                              TaskParams(
                                id: widget.editItem!.id,
                                uid: widget.editItem?.uid,
